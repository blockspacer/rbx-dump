...
if BaseUrl:find("www.sitetest4.robloxlabs.com") or BaseUrl:find("gametest1") then
...
function showBuildToolsTutorial()
	...
	local firstPage = RbxGui.CreateImageTutorialPage(" ", "http://www.sitetest4.robloxlabs.com/asset/?id=59162193", 359, 296, function() dismissTutorial() end, true)
